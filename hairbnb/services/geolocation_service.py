################################################################################
#                                                                              #
#         SERVICE DE GÉOLOCALISATION VIA UNE API EXTERNE (NOMINATIM)           #
#                                                                              #
#  Ce fichier définit une classe de service, `GeolocationService`, qui agit    #
#  comme une interface pour interagir avec des services de géocodage externes. #
#  Son rôle est de convertir des adresses postales en coordonnées              #
#  géographiques (latitude et longitude).                                      #
#                                                                              #
#  L'encapsulation de cette logique dans une classe dédiée permet de           #
#  centraliser et de simplifier l'utilisation du géocodage dans le reste de    #
#  l'application, et facilite le changement de fournisseur d'API si nécessaire.#
#                                                                              #
################################################################################
import requests
